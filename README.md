...
- TI's two-page schematic was transcribed from SNOU148A Figures 27 and 28 and laid out as two native tscircuit sheets with five native schematic sections. U1 is projected as U1A-U1D op-amp units, the LaunchPad connectors/LEDs sit below the PIR signal chain, and the power/current-monitor circuit occupies sheet 2. C22 is correctly placed across R21, and NT1/NT2/NT3 preserve TI's rail split.
...
- Published tscircuit package: <https://tscircuit.com/abse/boostxl-tlv8544pir> (`1.0.11`)
