import objPath from "./A_1N4148X_TP.obj"
import stepPath from "./A_1N4148X_TP.step"
...
export const A_1N4148X_TP = (props: DiodeProps) => {
  ...
  "jlcpcb": [
    "C507292"
      ...
      footprint={<footprint>
        <smtpad portHints={["pin1","cathode","neg"]} points={[{x: "-1.016mm", y: "0.2463038mm"}, {x: "-0.4064mm", y: "0.2463038mm"}, {x: "-0.4064mm", y: "-0.2362962mm"}, {x: "-1.016mm", y: "-0.2362962mm"}]} shape="polygon" />
<smtpad portHints={["pin2","anode","pos"]} points={[{x: "0.4064mm", y: "0.2362962mm"}, {x: "1.016mm", y: "0.2362962mm"}, {x: "1.016mm", y: "-0.2463038mm"}, {x: "0.4064mm", y: "-0.2463038mm"}]} shape="polygon" />
